                               ...
                               TThhee FFIIXXIITT DDeebbuuggggeerr
             ...
             1155..11..   IInnttrroodduuccttiioonn    FIXIT  is a debugging environment
                ...
                tation is resumed.
                     ...
                     To enter the debugger type _(_d_e_b_u_g_).  The debugger
                goes into its own read-eval-print loop.  Like the top-
                level, the debugger understands certain  special  com-
                mands.   One  of these is help, which prints a list of
                the available commands.  The basic idea  is  that  you
          ...
          TThhee FFIIXXIITT DDeebbuuggggeerr                                      1155--11
          ...
          TThhee FFIIXXIITT DDeebbuuggggeerr                                      1155--22
                ...
                lisp system.  Evaluating _(_*_r_s_e_t _t_) tells the lisp sys-
                tem  to  maintain this information.  If you are debug-
                ging compiled code you should also be  sure  that  the
                compiled  code  to  compiled  code  linkage tables are
                unlinked, i.e do _(_s_s_t_a_t_u_s _t_r_a_n_s_l_i_n_k _n_i_l_).
          ...
          ((ddeebbuugg [ s_msg ]))
               ...
               NOTE: Within a program, you  may  enter  a  debug  loop
                     ...
                     would normally put a call to _b_r_e_a_k_.  Also, within
                     a break loop you may enter FIXIT by typing _d_e_b_u_g_.
                     If an argument is given to DEBUG, it  is  treated
                     as  a message to be printed before the debug loop
                     is entered.  Thus you can put _(_d_e_b_u_g _|_j_u_s_t _b_e_f_o_r_e
                     _l_o_o_p_|_)  into  a  program to indicate what part of
          ...
          TThhee FFIIXXIITT DDeebbuuggggeerr                                      1155--33
          ...
          TThhee FFIIXXIITT DDeebbuuggggeerr                                      1155--44


             1155..22..  IInntteerraaccttiioonn wwiitthh _t_r_a_c_e    FIXIT  knows  about  the
                ...
                tion to _t_r_a_c_e_'_s hackery by printing an appropriate tag
                next to these stack entries.




             1155..33..   IInntteerraaccttiioonn wwiitthh _s_t_e_p    The _s_t_e_p function may be
             ...
             1155..44..   MMuullttiippllee eerrrroorr lleevveellss   FIXIT will evaluate arbi-
                trary LISP expressions in its debug loop.  The evalua-
                tion  is  not  done  within an _e_r_r_s_e_t_, so, if an error
