...
(generate-xref-file lambda flatc + terprchk cdar print not terpr msg-print progn msg nreverse or liszt-internal-do mapcar patom list memq typeit ncons cxr getd cdr cadar caar concat cons sortcar length lessp cond If get car null do quote sort setq)
