...
/*
 *	BZS - add device dependant routines
 */
int bw2dd();
int cg2dd();
int pixwindd();
...
/*
 *	BZS - he seemed to have forgotten all the device dependant routines(!)
 *	(I only include the SUN/2 routines here for now)
 */
{"_bw2dd", bw2dd, &disc},
{"_cg2dd", cg2dd, &disc},
{"_pixwindd", pixwindd, &disc},
{"_cgpixwindd",cgpixwindd,&disc},
{0}
};
