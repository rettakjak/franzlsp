...
#if sun_4_2beta || sun_4_2 || sun_4_1c || sun3_sunos4
#define m_68k		1
#ifdef mc68020
...
#endif
#if sun3_sunos4
/* [SWF] the #ifdef OS4 was put in place to accommidate sun0s3.5 */
#ifdef OS4
#define SUNOS4	1 
#endif
#define os_4_2	1	/* SUNOS4 is sort of 4.2 (avoid too many other edit this way !*/
#define sun_4_2 1	/* ditto -- don't want to change .c files [DES] 6feb89 */
#endif
#if vax_4_3
#define os_4_3		1
#endif
 ...
 */
#if ! (os_4_1a || os_4_1c || os_4_2 || os_4_3 || SUNOS4)
...
#if (sun_4_2 || sun_4_2beta || sun3_sunos4 || HOLE)
#define TTSIZE 10216
#else
#define TTSIZE 6120
#endif
